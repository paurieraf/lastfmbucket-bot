...
| `/collage` | `[size] [period] [entity] [tile_size] [theme:..] [overlay:..] [preset:..] [filter:..] [bold] [notext] [noplaycount] [corner:..] [border:..] [border_color:..] [spacing:..] [fallback:..]` *(optional)* | `commands.collage` | Generates a composite visual image grid (1x1 to 20x20, max 400 tiles, dynamic resolution scaling) using `lastfmcollagegenerator` v1.3.1 asynchronously, with themes, overlays, visual filters, bold text, WebP export, social presets, tile geometry and a persistent artwork cache (`data/collage_cache/`). | Photo with caption or 4-Tier Keyboard (entity → size/preset → period → style) |
