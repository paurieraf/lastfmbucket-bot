...
| 6 | `/collage` | `collage` (`commands.py:426`) | Generates composite collage photo (1x1 to 20x20, max 400 tiles, dynamic resolution, optional `tile_size`, themes, filters, bold, WebP export) using `lastfmcollagegenerator` v1.3.1 asynchronously. | Photo with HTML caption or 4-Tier Keyboard |
